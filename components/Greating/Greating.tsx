  ...
  return (
    <section className={style.greating}>
      ...
      <div className={style.greating__text}>
        ...
        времени. <span style={{color: "red"}}> Хочу отметить, что на данном этапе я не даю гарантий, что все реализовано верно, однако же задачу у меня приняли.</span> В дальнейшем хочу реализовать различные проекты с
        использовванием API различных библиотек.
      </div>
    </section>
  );
}
